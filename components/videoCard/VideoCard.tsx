...
const VideoCard = ({ post, index = 0 }: VideoCardProps) => {
    const { user } = useUser()
            ...
            >
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                    ...
                    <div className="flex flex-row items-center justify-between gap-3 sm:gap-0 pt-2 border-t border-slate-50">
                        {/* Author */}
                        {post.channel_name && post.channel_name !== 'null' && (
                            <Link
                                href={`/author/${encodeURIComponent(post.channel_name)}`}
                            ...
                            >
                                ...
                                <span className="text-xs sm:text-sm font-semibold text-slate-700 truncate">{post.channel_name}</span>
                            </Link>
                        )}
